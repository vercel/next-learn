...
export function CardSkeleton() {
  return (
    ...
    >
      ...
      <div className="mt-4 h-8 w-1/2 rounded-lg bg-gray-200"></div>
    </div>
  );
}
...
export function RevenueChartSkeleton() {
  return (
    ...
    >
      ...
      <div className="my-4 h-[370px] w-full rounded-lg bg-gray-200"></div>
    </div>
  );
}
    ...
    >
      ...
      <div className="mt-8 flex flex-row items-center justify-between">
        <div className="flex items-center">
          ...
          <div className="ml-4 h-10 w-44 rounded-lg bg-gray-200"></div>
        </div>
