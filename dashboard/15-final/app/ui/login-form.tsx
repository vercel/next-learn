...
export default function LoginForm() {
  ...
  return (
    <div className="flex items-center justify-center md:h-screen">
      <div
        className="relative mx-auto flex h-screen w-full max-w-[400px] flex-col space-y-2.5 p-4 md:-mt-32 md:h-auto"
      ...
      >
        <div className="flex h-36 w-full items-end rounded-lg bg-blue-600 p-3">
          ...
          >
            <g clip-path="url(#clip0_48_26148)">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
        ...
        <div className="flex-1 space-y-3 rounded-lg bg-gray-50 px-3 pb-6 pt-4">
          <h1 className={clsx(lusitana.className, 'ml-3 text-2xl')}>
